...
import 'package:colibricmflutter/Widget/Style1Widget.dart';
import 'package:colibricmflutter/Widget/Style2Widget.dart';
import 'package:colibricmflutter/Widget/Style3Widget.dart';
import 'package:colibricmflutter/Widget/Style4Widget.dart';
import 'package:colibricmflutter/Widget/StyleDefaultWidget.dart';
import 'package:colibricmflutter/controllers/ZoomDrawerContext.dart';
...
/// https://fluttercrafters.com/
/// https://ameen.fluttercrafters.com/
///
/// }
...
class ZoomDrawerAmeenHamedFlutterCrafters extends StatefulWidget {
  const ZoomDrawerAmeenHamedFlutterCrafters({
  ...
  final ZoomDrawerAmeenHamedFlutterCraftersController? controller;
  ...
  /// By using ZoomDrawerAmeenHamedFlutterCrafters.of(context)?.close()
  ...
  @override
  ZoomDrawerAmeenHamedFlutterCraftersState createState() =>
      ZoomDrawerAmeenHamedFlutterCraftersState();

  /// static function to provide the drawer state
  static ZoomDrawerAmeenHamedFlutterCraftersState? of(BuildContext context) =>
      context
          .findAncestorStateOfType<ZoomDrawerAmeenHamedFlutterCraftersState>();
}

class ZoomDrawerAmeenHamedFlutterCraftersState
    extends State<ZoomDrawerAmeenHamedFlutterCrafters>
  ...
  void didUpdateWidget(
      covariant ZoomDrawerAmeenHamedFlutterCrafters oldWidget) {
