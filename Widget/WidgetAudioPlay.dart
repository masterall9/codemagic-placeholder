...
class WidgetAudioPlay extends StatefulWidget {
  const WidgetAudioPlay({super.key, required this.urlsSong});
  final String urlsSong;

  @override
  State<WidgetAudioPlay> createState() => _WidgetAudioPlayState();
}

class _WidgetAudioPlayState extends State<WidgetAudioPlay> {
