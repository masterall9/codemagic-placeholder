...
class ApiFeeds {
  static Future<List<feedsModel>> fet(
    ...
    String fileName = "$listId+PostsCash.json";
    var url = Uri.parse(accounts[0]['fd'] +
        accounts[0]['sized'] +
        sized +
        accounts[0]['ofs'] +
        listId);
    ...
    File file = new File(dir.path + "/$listId" + fileName);
    ...
    try {
      ...
      if (datajson['status'] == 500) {
        ...
        if (await datajson['code'] == '401') {
          ...
          if (datajson['code'] == 204) {
            ...
            var wwwdata = datajson['data']['feeds'];
      ...
      var datadecde = dataReed['data']['feeds'];
      print(listId);
