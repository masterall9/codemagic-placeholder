...
class WidgetMyPostsMedia extends StatefulWidget {
  WidgetMyPostsMedia({
    super.key,
    required this.type,
    this.user_id,
  ...
  @override
  State<WidgetMyPostsMedia> createState() => _WidgetMyPostsMediaState();
}

class _WidgetMyPostsMediaState extends State<WidgetMyPostsMedia> {
