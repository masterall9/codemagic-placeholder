...
class WidgetLikedPosts extends StatefulWidget {
  WidgetLikedPosts({super.key, required this.type, this.user_id});
  final String type;
  final user_id;

  @override
  State<WidgetLikedPosts> createState() => _WidgetLikedPostsState();
}

class _WidgetLikedPostsState extends State<WidgetLikedPosts> {
  ...
  Future<void> getPost() async {
    ApiGetMyPost.fet(
            id: widget.user_id == null
                ? await SharedP.Get('user_id')
                : widget.user_id,
            media: widget.type,
            username: '')
        .then((value) {
