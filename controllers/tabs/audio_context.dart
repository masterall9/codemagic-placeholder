...
import 'package:colibricmflutter/controllers/components/cbx.dart';
import 'package:colibricmflutter/controllers/components/drop_down.dart';
import 'package:colibricmflutter/controllers/components/tab_content.dart';
import 'package:colibricmflutter/controllers/components/tabs.dart';
        ...
        return Cbx(
          ...
          ({value}) {
            updateAudioContextIOS(() {
              final iosContext = AudioContextIOS();
              if (value ?? false) {
                options.add(option);
              } else {
